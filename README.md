...
In contrast to the original cycleGAN, it uses only one generator and one discriminator. Both generator and discriminator take hair color labels as additional input. For more details see my [project report](http://cs230.stanford.edu/projects_winter_2020/reports/32582032.pdf) and [poster](http://cs230.stanford.edu/projects_winter_2020/posters/32582032.pdf) for the Stanford CS230 class.
